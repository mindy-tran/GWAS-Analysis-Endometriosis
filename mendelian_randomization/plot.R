...
setwd("/projectnb/bs859/students/mindyt5/GWAS-Analysis-Endometriosis/mendelian_randomization")
gsmr_data = read_gsmr_data("ENDO_migraine-gsmr.eff_plot.gz")
gsmr_summary(gsmr_data)      # show a summary of the data
plot_gsmr_effect(gsmr_data, "migraine", "endo", colors()[75])  

gsmr_data = read_gsmr_data("ENDO_osteoarthritis-gsmr.eff_plot.gz")
gsmr_summary(gsmr_data)      # show a summary of the data
plot_gsmr_effect(gsmr_data, "osteoarthritis", "endo", colors()[75])  

gsmr_data = read_gsmr_data("ENDO_menorrhagia-gsmr.eff_plot.gz")
gsmr_summary(gsmr_data)      # show a summary of the data
plot_gsmr_effect(gsmr_data, "menorrhagia", "endo", colors()[75])  

gsmr_data = read_gsmr_data("ENDO_dysmenorrhea-gsmr.eff_plot.gz")
gsmr_summary(gsmr_data)      # show a summary of the data
plot_gsmr_effect(gsmr_data, "dysmenorrhea", "endo", colors()[75])  
